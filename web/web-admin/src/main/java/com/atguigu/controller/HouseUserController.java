...
public class HouseUserController extends BaseController {
   ...
   public String update( @PathVariable Long id, HouseUser houseUser, HttpServletRequest request) {

      HouseUser currentHouseUser = houseUserService.getById(id);

      currentHouseUser.setName(houseUser.getName());
      currentHouseUser.setPhone(houseUser.getPhone());
      currentHouseUser.setSex(houseUser.getSex());
      currentHouseUser.setIdNo(houseUser.getIdNo());
